...
public class JSONParser {
    protected LinkedHashSet<Plants> getArrPlants(String txt){
        ...
        LinkedHashSet<Plants> arr = new LinkedHashSet<>();
        String str = "\\}[, \n\r]*\\{";
    ...
    protected Plants objParse(String jsontxt)throws JSONException{
        boolean name = false;
    ...
    protected String getWrittenPlants(LinkedHashSet<Plants> linkPlants){
        String str = "[\n";
